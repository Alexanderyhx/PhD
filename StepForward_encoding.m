    ...
    if sample_amount_for_training>0
        ...
        for s=1:sample_amount_for_training
            for f=1:inputnum
                ...
                for t=2:timelength % this part makes positive and negative spikes for each timelength
